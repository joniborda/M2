...
#define INST_INICIO_CONEXION_BT     24 // INSTRUCCION QUE INDICA QUE SE CONECTO UN DISPOSITIVO BLUETOOTH
#define INST_FIN_RIEGO_MANUAL       25 // INSTRUCCION QUE INDICA QUE SE FINALIZO EL RIEGO MANUAL
#define INST_DETENER_RIEGO_MANUAL   26 // INSTRUCCION QUE DETIENE EL RIEGO MANUAL
